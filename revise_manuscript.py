...
if p_intro:
    ...
    abstract_body = ('Apparently balanced chromosomal rearrangements identified by '
        ...
        'karyotyping and microarray resolve neither cryptic imbalances nor '
        'breakpoint context. We applied integrated long-read sequencing (LRS) and '
        'optical genome mapping (OGM) to three NDD probands with apparently '
        'balanced karyotypes. In Case 1, a girl with microcephaly, growth '
        'restriction, developmental delay, and seizures, inv(8)(p23p11.2) reported '
        'prenatally was resolved as a deletion–inversion–deletion event '
        'encompassing the 8p23.1 microdeletion region, explaining the phenotype '
        'while sparing GATA4, concordant with absent congenital heart disease; the '
        'rearrangement showed breakpoints attributable to low-copy-repeat–mediated '
        'non-allelic homologous recombination and microhomology-mediated end '
        'joining at distinct junctions. In Case 2, a man with intellectual '
        'disability, autism, ADHD, micrognathia, and scoliosis whose prior exome '
        'sequencing was non-diagnostic, a breakpoint of inv(7)(q11.21q22) '
        'truncated AUTS2, establishing a diagnosis of AUTS2-related syndrome. In '
        'Case 3, a boy with developmental delay, autism, and ADHD whose karyotype '
        'showed two reciprocal translocations, LRS and OGM resolved a complex '
        'multi-chromosomal rearrangement reminiscent of chromoanagenesis, in which '
        'CNTNAP2 truncation and a cryptic 5.4-Mb 7q34–q35 deletion together '
        'explained his phenotype. Integrated LRS and OGM converted ambiguous '
        'karyotypes into precise molecular diagnoses and clarified '
        'genotype–phenotype correlations beyond the reach of conventional '
        'cytogenetics.')
